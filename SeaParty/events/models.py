...
class SubCategory(models.Model):
    ...
    SubCategory_name=models.CharField(max_length=3,choices=SubCategories,primary_key=True)
class Category(models.Model):
    ...
    Category_name=models.CharField(max_length=3,choices=Categories,primary_key=True)
...
class Location(models.Model):
    ...
    Region = models.CharField(max_length=3,choices=Region_CHOICES,blank=True)
...
class Events(models.Model):
    ...
    Event_Cost = models.DecimalField(default=0)
